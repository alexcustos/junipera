...
package com.junilabs.keyboard.keyboard.emoji;

import static com.junilabs.keyboard.latin.common.Constants.NOT_A_COORDINATE;
...
import com.junilabs.keyboard.keyboard.Key;
import com.junilabs.keyboard.keyboard.KeyboardActionListener;
import com.junilabs.keyboard.keyboard.KeyboardLayoutSet;
import com.junilabs.keyboard.keyboard.KeyboardView;
import com.junilabs.keyboard.keyboard.internal.KeyDrawParams;
import com.junilabs.keyboard.keyboard.internal.KeyVisualAttributes;
import com.junilabs.keyboard.keyboard.internal.KeyboardIconsSet;
import com.junilabs.keyboard.latin.AudioAndHapticFeedbackManager;
import com.junilabs.keyboard.latin.LatinIME;
import com.junilabs.keyboard.R;
import com.junilabs.keyboard.latin.RichInputMethodSubtype;
import com.junilabs.keyboard.latin.common.Constants;
import com.junilabs.keyboard.latin.settings.Settings;
import com.junilabs.keyboard.latin.utils.ResourceUtils;
...
public final class EmojiPalettesView extends LinearLayout implements OnTabChangeListener,
    ...
    private ImageButton mShareKey;
    //private TextView mAlphabetKeyLeft;
    private RelativeLayout mEmojiKeyboardCategory;
    ...
    protected void onFinishInflate() {
        ...
        RecyclerView packRecyclerView = (RecyclerView)findViewById(R.id.pack_recycler_view);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
        packRecyclerView.setLayoutManager(layoutManager);
        LatinIME latinIME = (LatinIME) Settings.getInstance().getContext();
        mKeyboardService = latinIME.getKeyboardService();
        if (mKeyboardService != null) {
            mKeyboardService.setPackView(packRecyclerView);
        }
        mEmojiPalettesAdapter = new EmojiPalettesAdapter(mEmojiCategory, this, mKeyboardService);
        ...
        mShareKey = (ImageButton)findViewById(R.id.emoji_keyboard_share);
        mShareKey.setBackgroundResource(mFunctionalKeyBackgroundId);
        mShareKey.setTag(Constants.CODE_SHARE);
        mShareKey.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mKeyboardService != null)
                    mKeyboardService.shareLinkToGP();
            }
        });
     ...
     * {@link com.junilabs.keyboard.keyboard.emoji.EmojiPageKeyboardView.OnKeyEventListener}
